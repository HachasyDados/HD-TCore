...
UPDATE `quest_template` SET `ExclusiveGroup` = 11360, `NextQuestId`= 12135 WHERE `entry` IN (11360, 11439, 11440);
-- Fire Training (Horde) (Only 1 may be completed)
UPDATE `quest_template` SET `ExclusiveGroup` = 11361, `NextQuestId` = 12139 WHERE `entry` IN (11361, 11449, 11450);
-- "Let the fires come" and Stop the Fires! (Only 1 may be completed) (Remove party accept)
UPDATE `quest_template` SET `QuestFlags` = 4104, `ExclusiveGroup` = 12135, `PrevQuestId` = 0 WHERE `entry`IN (12135, 11131); -- Alliance
UPDATE `quest_template` SET `QuestFlags` = 4104, `ExclusiveGroup` = 12139, `PrevQuestId` = 0 WHERE `entry`IN (12139, 11219); -- Horde
-- The Headless Horseman may only be taken if completed the quest "Smashing the pumpkin"
UPDATE `quest_template` SET `NextQuestId` = 11135 WHERE `entry` = 12133; -- Alliance
UPDATE `quest_template` SET `NextQuestId` = 11220 WHERE `entry` = 12155; -- Horde
